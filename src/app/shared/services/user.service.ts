...
const playerApi = environment.apiUrl + '/users';
@Injectable({
    providedIn: 'root'
})
...
export class UserListService {
    ...
    getList() {
      let  data = {
        ...
        return this.http.post<any>(playerApi, data).pipe(
            map((response: any) => {
  ...
  getPlayer(id:any) {
    return this.http.get<any>(playerApi +'/'+id);
  }

  updatePlayer(id: string, data: any) {
    return this.http.post<any>(playerApi +'/'+id, data);
  }
  
  updatePlayerStatus(id: string, data: any) {
    return this.http.post<any>(playerApi +'/status/'+id, data);
  }
  deletePlayer(id: string) {
    return this.http.delete(playerApi +'/'+id);
  }
  kycList(data: any) {
    let params = new HttpParams();
        params =params.append('kycStatus', 'notverified');
        return this.http.post<any>(playerApi, data, {params});

  }
  bannedList(data: any) {
    let params = new HttpParams();
    params =params.append('status', 'banned');
    return this.http.post(playerApi, data,{params});
